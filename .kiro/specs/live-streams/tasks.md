...
- [ ] 3. Create Pydantic schemas for API request/response validation
...
- [ ] 4. Implement ingestion API endpoint
- [ ] 4.1 Create basic ingestion router structure
...
- [ ] 4.2 Implement stream upsert and bet insertion logic
...
- [ ] 4.3 Add comprehensive error handling and responses
  - Implement proper HTTP status codes and error messages
  - Add validation error responses with detailed field information
  - Handle database constraint violations gracefully
  - _Requirements: 1.4, 1.5, 7.5_

- [ ] 5. Implement live streams query APIs
- [ ] 5.1 Create streams listing endpoint
...
- [ ] 5.2 Create stream detail endpoint
...
- [ ] 5.3 Create paginated bets listing endpoint
...
- [ ] 5.4 Create tail endpoint for incremental updates
...
- [ ] 6. Implement stream management endpoints
- [ ] 6.1 Create stream deletion endpoint
...
- [ ] 6.2 Create stream update endpoint
...
- [ ] 6.3 Create CSV export endpoint
...
- [ ] 7. Integrate live streams router with main application
...
- [ ] 8.1 Create LiveStreamsList page component
...
- [ ] 8.2 Create LiveStreamDetail page component
